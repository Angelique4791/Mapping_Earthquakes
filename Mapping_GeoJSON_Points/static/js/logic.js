...
// Add GeoJSON data. *Note lat/long coordinates are reverse in geoJSON object.
let sanFranAirport =
...
L.geoJSON(sanFranAirport,  {
    ...
    // Turn a single feature into a marker on the map.
...
// }).addTo(map);
    ...
    onEachFeature: function(feature, layer) {
        layer.bindPopup("<h1>" + feature.properties.name + "</h1>" + "<h2>" + feature.properties.city + ", " + feature.properties.country + "</h2>");
       }
}).addTo(map);
